...
***ARO-Master*** is a project to implement an affordable and easy to build control system for ***Automated Remote/Robotic Observatories*** with **Roll-Off-Roof** and it's main components are:
